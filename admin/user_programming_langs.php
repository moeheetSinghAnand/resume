    ...
    <div class="modal-content">
      ...
      <form method="post">
        <div class="modal-body">
         <label for="programmingLanguageName" class="mb-2">Programming Skill</label>
          <input class="form-control mb-3" type="text" placeholder="programming skill" id="programmingLanguageName" name="programmingLanguageName" required>
        </div>
    ...
    <div class="modal-content">
      ...
      <form method="post">
        ...
        <label for="editProgrammingLanguageName" class="mb-2">Programming Skill</label>
          <input class="form-control mb-3" type="text" placeholder="programming Skill" id="editProgrammingLanguageName" name="editProgrammingLanguageNametcategoryName" required>
        </div>
        <div class="modal-footer">
          <button class="btn btn-danger" data-bs-dismiss="modal">Close</button>
          <button class="btn btn-primary" type="button" value="submit" name="submit">Submit</button>
...
<!-- Delete Modal -->
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <input class="form-control mb-3" type="text" placeholder="programming skill" id="deleteProgrammingLanguageName" name="deleteProgrammingLanguageName" required>
        </div>
        <div class="modal-footer">
            <button class="btn btn-danger" data-bs-dismiss="modal">Close</button>
            <button class="btn btn-primary" type="button" value="submit" name="submit">Submit</button>

      ...
      <form method="post">
        <div class="modal-body">
         <label for="designationName" class="mb-2">Designation</label>
          <input class="form-control mb-3" type="text" placeholder="designation" id="designationName" name="designationName" required>
        </div>
    ...
    <div class="modal-content">
      ...
      <form method="post">
        ...
        <label for="editDesignationName" class="mb-2">Designation</label>
          <input class="form-control mb-3" type="text" placeholder="designation" id="editDesignationName" name="editDesignationName" required>
        </div>
        <div class="modal-footer">
          <button class="btn btn-danger" data-bs-dismiss="modal">Close</button>
          <button class="btn btn-primary" type="button" value="submit" name="submit">Submit</button>
...
<!-- Delete Modal -->
    ...
    <div class="modal-content">
        ...
        <form method="post">
        <div class="modal-body">
            <label for="deleteDesignationName" class="mb-2">Designation Name</label>
            <input class="form-control mb-3" type="text" placeholder="designation name" id="deleteDesignationName" name="deleteDesignationName" required>
        </div>
        <div class="modal-footer">
            <button class="btn btn-danger" data-bs-dismiss="modal">Close</button>
            <button class="btn btn-primary" type="button" value="submit" name="submit">Submit</button>

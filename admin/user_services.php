      ...
      <form method="post">
        <div class="modal-body">
         <label for="serviceName" class="mb-2">Service</label>
          <input class="form-control mb-3" type="text" placeholder="service" id="serviceName" name="serviceName" required>
        </div>
    ...
    <div class="modal-content">
      ...
      <form method="post">
        ...
        <label for="editserviceName" class="mb-2">Service</label>
          <input class="form-control mb-3" type="text" placeholder="service" id="editserviceName" name="editserviceName" required>
        </div>
        <div class="modal-footer">
          <button class="btn btn-danger" data-bs-dismiss="modal">Close</button>
          <button class="btn btn-primary" type="button" value="submit" name="submit">Submit</button>
...
<!-- Delete Modal -->
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <input class="form-control mb-3" type="text" placeholder="service name" id="deleteServiceName" name="deleteServiceName" required>
        </div>
        <div class="modal-footer">
            <button class="btn btn-danger" data-bs-dismiss="modal">Close</button>
            <button class="btn btn-primary" type="button" value="submit" name="submit">Submit</button>

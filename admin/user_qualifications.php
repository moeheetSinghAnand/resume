      ...
      <form method="post">
        <div class="modal-body">
         <label for="qualificationName" class="mb-2">Qualification</label>
          <input class="form-control mb-3" type="text" placeholder="qualification" id="qualificationName" name="qualificationName" required>
        </div>
    ...
    <div class="modal-content">
      ...
      <form method="post">
        ...
        <label for="editQualificationName" class="mb-2">Qualification</label>
          <input class="form-control mb-3" type="text" placeholder="qualification" id="editQualificationName" name="editQualificationName" required>
        </div>
        <div class="modal-footer">
          <button class="btn btn-danger" data-bs-dismiss="modal">Close</button>
          <button class="btn btn-primary" type="button" value="submit" name="submit">Submit</button>
...
<!-- Delete Modal -->
    ...
    <div class="modal-content">
        ...
        <form method="post">
        <div class="modal-body">
            <label for="categoryName" class="mb-2">Qualifcation</label>
            <input class="form-control mb-3" type="text" placeholder="qualification" id="deleteQualificationName" name="deleteQualificationName" required>
        </div>
        <div class="modal-footer">
            <button class="btn btn-danger" data-bs-dismiss="modal">Close</button>
            <button class="btn btn-primary" type="button" value="submit" name="submit">Submit</button>

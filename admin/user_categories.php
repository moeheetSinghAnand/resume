      ...
      <form method="post">
        <div class="modal-body">
         <label for="categoryName" class="mb-2">Category</label>
          <input class="form-control mb-3" type="text" placeholder="category" id="categoryName" name="categoryName" required>
        </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="post">
        <div class="modal-body">
        <label for="categoryName" class="mb-2">Category</label>
          <input class="form-control mb-3" type="text" placeholder="category" id="editcategoryName" name="editcategoryName" required>
        </div>
        <div class="modal-footer">
          <button class="btn btn-danger" data-bs-dismiss="modal">Close</button>
          <button class="btn btn-primary" type="button" value="submit" name="submit">Submit</button>
...
<!-- Delete Modal -->
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <input class="form-control mb-3" type="text" placeholder="category name" id="deletecategoryName" name="deletecategoryName" required>
        </div>
        <div class="modal-footer">
            <button class="btn btn-danger" data-bs-dismiss="modal">Close</button>
            <button class="btn btn-primary" type="button" value="submit" name="submit">Submit</button>

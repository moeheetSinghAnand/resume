                        ...
                        <table id="datatable1" class="table table-bordered">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td scope="">Arter</td>
                              <td scope="">Carter</td>
                              <td scope="">Artur Carter</td>
                              <td scope="">arter_carter666</td>
                              <td scope="">artercarter@gmail.com</td>
                              <td scope="">780771142653</td>
                              <td scope="">12 toronto street</td>
                              <td scope="">A1A1A1</td>
                              <td scope="">Canada</td>
                            ...
                            <tr>
                              ...
                              <td scope="">Mohit</td>
                              <td scope="">Anand</td>
                              <td scope="">Mohit Anand</td>
                              <td scope="">mohit_anand666</td>
                              <td scope="">anandmohitsingh@gmail.com</td>
                              <td scope="">780771142453</td>
                              <td scope="">Phulwari Shareef</td>
                              <td scope="">805105</td>
                              <td scope="">India</td>
            ...
            <div class="modal-body">
              <div class="row g-1">
                ...
                <div class="col-6 mb-2">
                  ...
                  <input type="email" class="form-control" id="e-mail" name="e-mail" placeholder="Enter your email"
                    required>
                </div>
                ...
                <div class="col-6 mb-2">
                  ...
                  <input type="text" class="form-control" id="telegram" name="telegram" placeholder="Enter your tele"
                    required>
                </div>
                ...
                <div class="col-6 mb-2">
                  ...
                  <input type="number" class="form-control" id="office_no" name="office_no"
                    placeholder="Enter your office number" required>
                </div>
              </div>
            </div>

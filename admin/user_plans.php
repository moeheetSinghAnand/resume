    ...
    <div class="modal-content">
      ...
      <form method="post">
        <div class="modal-body">
         <label for="designationName" class="mb-2">Plan</label>
          <input class="form-control mb-3" type="text" placeholder="plan" id="designationName" name="designationName" required>
        </div>
    ...
    <div class="modal-content">
      ...
      <form method="post">
        ...
        <label for="editPlanName" class="mb-2">Plan</label>
          <input class="form-control mb-3" type="text" placeholder="plan" id="editPlanName" name="editPlanName" required>
        </div>
        <div class="modal-footer">
          <button class="btn btn-danger" data-bs-dismiss="modal">Close</button>
          <button class="btn btn-primary" type="button" value="submit" name="submit">Submit</button>
...
<!-- Delete Modal -->
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <input class="form-control mb-3" type="text" placeholder="plan name" id="deletePlanName" name="deletePlanName" required>
        </div>
        <div class="modal-footer">
            <button class="btn btn-danger" data-bs-dismiss="modal">Close</button>
            <button class="btn btn-primary" type="button" value="submit" name="submit">Submit</button>

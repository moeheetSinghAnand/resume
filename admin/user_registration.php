                                            ...
                                            <div class="mb-0 border-0 p-md-4 p-lg-0">
                                                ...
                                                <div class="pt-0">
                                                    <form action="index.php" class="my-4">
                                                        <div class="form-group mb-3">
                                                         ...
                                                         <div class="form-group mb-3">
                                                            ...
                                                            <input class="form-control" type="text" id="lastname" name="lastname" placeholder="Enter your first name" required >
                                                        </div>
                                                     ...
                                                     <div class="form-group mb-3">
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <input class="form-control" type="text" id="street" name="street" placeholder="Enter your street" required>
                                                        </div>
                                                         <div class="form-group mb-3">
                                                            <label for="pincode" class="form-label">Pincode</label>
                                                            <input class="form-control" type="number" id="pincode" name="pincode" placeholder="Enter your pincode" maxlength="6" required>
                                                        </div>
                                                        <div class="form-group mb-3">
                                                            <label for="telegram" class="form-label">Telegram</label>
                                                            <input class="form-control" type="text" id="telegram" name="telegram" placeholder="Enter your Telegram id">
                                                        </div>

                                                        <div class="form-group mb-3">
                                                            <label for="personal-no" class="form-label">Personal Number</label>
                                                            <input class="form-control" type="number" id="personal-no" name="personal-no" placeholder="Enter your personal no" maxlength="10" required>
                                                        </div>
                                                        <div class="form-group mb-3">
                                                            <label for="support-no" class="form-label">Support Number</label>
                                                            <input class="form-control" type="number" id="support-no" name="support-no" placeholder="Enter your support no" maxlength="10" required>
                                                        </div>

                                                        <div class="form-group mb-3">
                                                            <label for="office-no" class="form-label">Office Number</label>
                                                            <input class="form-control" type="number" id="office-no" name="office-no" placeholder="Enter your office no" maxlength="10" required>
                                                        </div>
                                                    ...
                                                    <div class="text-center text-muted">
                                                        <p class="mb-0">Already Signed Up ?<a class='text-primary ms-2 fw-medium' href='index.php'>Login</a></p>
                                                    </div>

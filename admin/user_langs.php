      ...
      <form method="post">
        <div class="modal-body">
         <label for="languageName" class="mb-2">Language</label>
          <input class="form-control mb-3" type="text" placeholder="language" id="languageName" name="languageName" required>
        </div>
    ...
    <div class="modal-content">
      ...
      <form method="post">
        ...
        <label for="editLanguageName" class="mb-2">Language</label>
          <input class="form-control mb-3" type="text" placeholder="language" id="editLanguageName" name="editLanguageName" required>
        </div>
        <div class="modal-footer">
          <button class="btn btn-danger" data-bs-dismiss="modal">Close</button>
          <button class="btn btn-primary" type="button" value="submit" name="submit">Submit</button>
...
<!-- Delete Modal -->
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <input class="form-control mb-3" type="text" placeholder="language " id="deleteLanguageName" name="deleteLanguageName" required>
        </div>
        <div class="modal-footer">
            <button class="btn btn-danger" data-bs-dismiss="modal">Close</button>
            <button class="btn btn-primary" type="button" value="submit" name="submit">Submit</button>

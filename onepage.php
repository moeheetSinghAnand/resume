        ...
        <div class="art-info-bar">
          ...
          <div class="art-info-bar-frame">
            ...
            <div class="art-header">
              ...
              <h5 class="art-name mb-10"><?php echo $user_global['first_name']. ' '. $user_global['last_name']; ?></h5>
              <!-- post -->
                ...
                <div class="row p-30-0">
                  ...
                  ?>
                    ...
                    <div class="art-counter-frame">
                      ...
                      <div class="art-counter-box">
                        <!-- counter number -->
                        <span class="art-counter"><?php echo $user_profile['experience'];  ?></span><span class="art-counter-plus">+</span>
                      </div>
                      <!-- counter end -->
                      <!-- title -->
                  ...
                  <div class="col-md-3 col-6">
                    ...
                    <div class="art-counter-frame">
                      ...
                      <div class="art-counter-box">
                        <!-- counter number -->
                        <span class="art-counter"><?php echo $user_profile['award_count'];  ?></span><span class="art-counter-plus">+</span>
                      </div>
                      <!-- counter end -->
                      <!-- title -->
                ...
                <div class="row p-30-0">
                  ...
                  <div class="art-grid art-grid-3-col art-gallery">
                    ...
                    <div class="art-grid-item webTemplates">
                      <!-- grid item frame -->
                      <a data-fancybox="gallery" href="assets/img/works/original-size/1.jpg" class="art-a art-portfolio-item-frame art-horizontal">
                        <!-- img -->
                        <img src="assets/img/works/thumbnail/1.jpg" alt="item">
                        <!-- zoom icon -->
                    ...
                    <div class="art-grid-item logos">
                      <!-- grid item frame -->
                      <a data-fancybox="gallery" href="assets/img/works/original-size/2.jpg" class="art-a art-portfolio-item-frame art-vertical">
                        <!-- img -->
                        <img src="assets/img/works/thumbnail/2.jpg" alt="item">
                        <!-- zoom icon -->
                        <span class="art-item-hover"><i class="fas fa-expand"></i></span>
                      </a>
                      <!-- grid item frame end -->
                    ...
                    <div class="art-grid-item drawings">
                      <!-- grid item frame -->
                      <a data-fancybox="gallery" href="assets/img/works/original-size/3.jpg" class="art-a art-portfolio-item-frame art-square">
                        <!-- img -->
                        <img src="assets/img/works/thumbnail/3.jpg" alt="item">
                        <!-- zoom icon -->
                        <span class="art-item-hover"><i class="fas fa-expand"></i></span>
                      </a>
                      <!-- grid item frame end -->
                    ...
                    <div class="art-grid-item ui">
                      <!-- grid item frame -->
                      <a data-fancybox="gallery" href="assets/img/works/original-size/4.jpg" class="art-a art-portfolio-item-frame art-vertical">
                        <!-- img -->
                        <img src="assets/img/works/thumbnail/4.jpg" alt="item">
                        <!-- zoom icon -->
                        <span class="art-item-hover"><i class="fas fa-expand"></i></span>
                      </a>
                      <!-- grid item frame end -->
                    ...
                    <div class="art-grid-item webTemplates">
                      <!-- grid item frame -->
                      <a data-fancybox="gallery" href="assets/img/works/original-size/5.jpg" class="art-a art-portfolio-item-frame art-square">
                        <!-- img -->
                        <img src="assets/img/works/thumbnail/5.jpg" alt="item">
                        <!-- zoom icon -->
                        <span class="art-item-hover"><i class="fas fa-expand"></i></span>
                      </a>
                      <!-- grid item frame end -->
                    ...
                    <div class="art-grid-item logos">
                      <!-- grid item frame -->
                      <a data-fancybox="gallery" href="assets/img/works/original-size/6.jpg" class="art-a art-portfolio-item-frame art-vertical">
                        <!-- img -->
                        <img src="assets/img/works/thumbnail/6.jpg" alt="item">
                        <!-- zoom icon -->
                        <span class="art-item-hover"><i class="fas fa-expand"></i></span>
                      </a>
                      <!-- grid item frame end -->
                    ...
                    <div class="art-grid-item drawings">
                      <!-- grid item frame -->
                      <a data-fancybox="gallery" href="assets/img/works/original-size/7.jpg" class="art-a art-portfolio-item-frame art-square">
                        <!-- img -->
                        <img src="assets/img/works/thumbnail/7.jpg" alt="item">
                        <!-- zoom icon -->
                        <span class="art-item-hover"><i class="fas fa-expand"></i></span>
                      </a>
                      <!-- grid item frame end -->
                    ...
                    <div class="art-grid-item ui">
                      <!-- grid item frame -->
                      <a data-fancybox="gallery" href="assets/img/works/original-size/8.jpg" class="art-a art-portfolio-item-frame art-horizontal">
                        <!-- img -->
                        <img src="assets/img/works/thumbnail/8.jpg" alt="item">
                        <!-- zoom icon -->
                        <span class="art-item-hover"><i class="fas fa-expand"></i></span>
                      </a>
                      <!-- grid item frame end -->
                    ...
                    <div class="art-timeline art-gallery" id="history">
                      ...
                      <div class="art-timeline-item">
                        ...
                        <div class="art-a art-timeline-content">
                          ...
                          <a data-fancybox="diplome" href="files/certificate.jpg" class="art-link art-color-link art-w-chevron"><?php echo $row1['certification'];  ?></a>
                        </div>
                      </div>
                    ...
                    <div class="art-a art-card">
                      ...
                      <form id="form" class="user-contact-form">
                        ...
                        <div class="art-form-field">
                          <!-- name input -->
                          <input id="cutomer_name" name="cutomer_name" class="art-input" type="text" placeholder="Name" required>
                          <!-- label -->
                        ...
                        <div class="art-form-field">
                          <!-- email input -->
                          <input id="customer_email" name="customer_email" class="art-input" type="email" placeholder="Email" required>
                          <!-- label -->
                        ...
                        <div class="art-form-field">
                          <!-- message textarea -->
                          <textarea id="customer_message" name="text" class="art-input" placeholder="Message" required></textarea>
                          <!-- label -->
                        ...
                        <div class="art-submit-frame">
                          <button class="art-btn art-btn-md art-submit" type="button" onclick="submitContactForm()"><span>Send message</span></button>
                          <!-- success -->
